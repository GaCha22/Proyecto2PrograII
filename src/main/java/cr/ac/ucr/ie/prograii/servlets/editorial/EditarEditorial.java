...
@WebServlet("/editorial/editarEditorial")

public class EditarEditorial extends HttpServlet {
    private EditorialDAO editorialDAO;
    private Editorial editorialEditar;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try (PrintWriter out = resp.getWriter()) {
            ...
            int codEditorial = Integer.parseInt(req.getParameter("editorial"));

            editorialEditar = new Editorial(codEditorial, nombreEditorial, ciudad);

            // editar editorial en el archivo
            try {
                EditorialDAO.abrirDocumento(path).editarEditorial(codEditorial, editorialEditar);
            } catch (Exception e) {
